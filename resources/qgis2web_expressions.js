...
function exp_200218_cbv_fdp_2rule0_eval_expression(context) {
    // Layer = 'UAPS_CONTEXTE_PARCELLAIRE'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Layer')  == 'UAPS_CONTEXTE_PARCELLAIRE');
    } else {
        return (feature.get('Layer')  == 'UAPS_CONTEXTE_PARCELLAIRE');
    }
}
...
function exp_200609ParcellaireQEP_3rule0_eval_expression(context) {
    // 
